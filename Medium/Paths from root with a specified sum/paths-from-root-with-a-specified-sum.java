...
class Solution
{
    public static ArrayList<ArrayList<Integer>> printPaths(Node root, int sum)
    {
        ...
        dfs(root,sum,0,temp,a1);
        return a1;
    }
    public static void dfs(Node node,int sum,int curr,ArrayList<Integer> temp,ArrayList<ArrayList<Integer>> a1){
        if(node==null){
            return ;
        }
        curr=curr+node.data;
        ...
        dfs(node.left,sum,curr,temp,a1);
        dfs(node.right,sum,curr,temp,a1);
