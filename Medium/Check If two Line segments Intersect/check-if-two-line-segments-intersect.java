...
class Solution {
    String doIntersect(int p1[], int q1[], int p2[], int q2[]) {
        ...
        if(o1!=o2 && o3!=o4){
         ...
         if(o1==0 && colinear(p1,q1,p2)){
            return "true";
        }
         if(o2==0 && colinear(p1,q1,q2)){
            return "true";
        }
         if(o3==0 && colinear(p2,q2,p1)){
            return "true";
        }
         if(o4==0 && colinear(p2,q2,q1)){
            return "true";
        }
        return "false";
    ...
    boolean colinear(int x1[],int x2[],int x3[]){
        if(x3[0]<=Math.max(x1[0],x2[0]) && x3[0]>=Math.min(x1[0],x2[0]) && x3[1]<=Math.max(x1[1],x2[1]) && x3[1]>=Math.min(x1[1],x2[1])){
            return true;
        }
        return false;
    }
